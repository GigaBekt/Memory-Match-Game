...
const GameBoard: React.FC<GameBoardProps> = memo(({ cards, onCardClick, difficulty }) => {
  const gridConfig = {
  ...
  return (
    <div 
      className={`grid ${gridConfig[difficulty as keyof typeof gridConfig]} gap-4 p-4 max-w-6xl mx-auto`}
      role="grid"
